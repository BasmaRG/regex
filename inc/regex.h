...
class RegEx {
private:
	std::deque<RegExState*> m_NFATable;
	std::deque<RegExState*> m_DFATable;
	std::stack<std::deque<RegExState*> > m_CharacterClassStack;
	...
	bool PopNFA(std::deque<RegExState*>  &NFATable);
